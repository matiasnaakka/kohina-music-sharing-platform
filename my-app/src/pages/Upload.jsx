...
export default function Upload({ session, player }) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto mt-16 p-6 bg-black bg-opacity-80 rounded-lg text-white pb-40">
        ...
        <form onSubmit={handleSubmit} className="mb-8">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              required
            />
            <p>Accepted formats: mpeg, wav, x-wav, aac, ogg, flac. Take a note larger file formats like FLAC or Wav may take longer to upload due to compression.</p>
          </div>
