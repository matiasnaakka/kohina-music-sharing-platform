      ...
      <div className="max-w-5xl mx-auto mt-16 p-6 pb-40">
        ...
        {isAuthenticated && (
          <section className="mb-8">
            ...
            {ownPlaylistsLoading ? (
              <div className="text-sm text-gray-400 px-3 py-2 rounded">Loading playlists...</div>
            ) : ownPlaylistsError ? (
              <div className="text-sm text-red-400 bg-red-500/20 px-3 py-2 rounded">{ownPlaylistsError}</div>
            ) : ownPlaylists.length === 0 ? (
              <div className="text-sm text-gray-400 px-3 py-2 rounded">Create a playlist to see it here.</div>
            ) : (
